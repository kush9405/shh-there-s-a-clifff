...
cliffEnv = gym.make("CliffWalking-v0", render_mode=None)  # Remove "human" if not needed
...
for episode in range(NUM_EPISODES):
    ...
    while not done:
        ...
        episode_length += 1
        total_reward += reward
        done = terminated or truncated #If either terminated or truncated is true, done=True and the loop terminates
